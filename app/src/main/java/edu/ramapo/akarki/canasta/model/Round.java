...
public class Round {
    ...
    public Round(final Round aOther) {
        ...
        mRoundStart = aOther.mRoundStart;
    ...
    /**
     * getter function to get the stock pile
     *
     * @return vectors of card, holds all the card that are in discard pile
     */
    public Vector<Card> getStockPile() {
        return mDeck.getStock();
    }
     ...
     * gets the playerlist
     *
     * @return Vector of player, holds the list of player
     */
    ...
    /**
     * checks if a player went out or not
     *
     * @return true if a player went out
     */
    public boolean hasPlayerWentOut() {
        return mPlayerWentOut;
    }

    /**
     * checks is last drawn card was red three
     *
     * @return true last drawn card was red 3
     */
    public boolean haslastCardRedThree() {
        return mLastCardR3Drwan;
    }


    /**
     * checks is mEndCausedCusDiscardPile status
     *
     * @return true mEndCausedCusDiscardPile is true
     */
    public boolean hasEndCauseDisCardPile() {
        return mEndCausedCusDiscardPile;
    }


    /**
     * checks is mRoundStart status
     *
     * @return true is this is the start of the round
     */
    public boolean hasRoundStartFlag() {
        return mRoundStart;
    }
    ...
    /**
     * sets round started flag
     * @param aRoundstarted  round started flag
     * @return true
     */
    public boolean setRoundStartedFlag(boolean aRoundstarted) {
        mRoundStart = aRoundstarted;
        return true;
    }
    ...
    public boolean turnStartLogic(Integer aUserChoice) {
        // at the strat of the turn, player have 5 choices:
     ...
     *                        menu
     */
    public boolean turnContinueLogic(Vector<Integer> aUserChoiceVec) {
     ...
     */
    public boolean emptyDiscardPile() {
        mDiscardPile.clear();
     ...
     */
    public boolean addToDiscardPile(Card aCardToAdd) {
